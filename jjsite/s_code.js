...
var s_account="outrainjjscit27site09"
...
s.linkInternalFilters="javascript:,ou-training.com,ou-training.com/jjsite/"
...
/*
 * Plugin: getPercentPageViewed v1.0
 */
s.getPercentPageViewed=new Function("",""
+"if(typeof(s.linkType)=='undefined'||s.linkType=='e'){var s_viewed=s"
+".c_r('s_ppv');s.c_w('s_ppv',0);return s_viewed;}");
...
+",pv=Math.round(vh/dh*100),cp=s.c_r('s_ppv');if(pv>cp){s.c_w('s_ppv'"
+",pv);}");
