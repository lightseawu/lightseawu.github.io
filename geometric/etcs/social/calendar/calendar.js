...
<pre>
{
     ...
     * @static
     */
    CQ.soco.calendar.TimeZone.UTC_ID = "etcs/UTC";
 ...
 */
/*
 * location: /etcs/clientlibs/social/calendar/calendar/source
 * category: [cq.soco.calendar]
 */
...
(function(CQ, $CQ) {
	...
	CQ.soco.calendar.utils.invokeFullCalendar = function(divTarget, url) {
		var _cal = $CQ(divTarget).fullCalendar({
			...
			buttonText: {
				prev: '<img src="/etcs/designs/geometrixx-outdoors/images/soco/mini-calendar-nav-left.png">',
				next: '<img src="/etcs/designs/geometrixx-outdoors/images/soco/mini-calendar-nav-right.png">'
			},
